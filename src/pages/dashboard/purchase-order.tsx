...
const PurchaseOrderModal = ({ close }: any) => {
    ...
    const { errors: apiError, isPurchaseOrderProcessing } = useSelector(
    ...
    return (
        <Modal close={close} title="Purchase Order" width='30%'>
            <form onSubmit={handleSubmit(onSubmit)} style={{ padding: '40px' }}>
                    ...
                    render={({ field }) => (
                        <div className="form-group">
                            <input
                                ...
                                step="any"
                                min="0"
                                readOnly={isPurchaseOrderProcessing}
                ...
                <div className="mt-3">
                    <button
                        ...
                        disabled={isPurchaseOrderProcessing}
                        type="submit"
                    >
                        SUBMIT
                    </button>
